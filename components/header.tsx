...
export default function Header() {
  ...
  return (
    <header className="z-50 relative">
      <motion.div
        className="fixed bottom-0 left-1/2  h-[4.5rem] w-full 
      ...
      ></motion.div>
      <nav
        className="py-2 flex fixed bottom-5 left-1/2 h-12 -translate-x-1/2 
        sm:bottom-auto sm:top-[1.7rem] sm:h-[initial] sm:py-0"
      >
        <ul
